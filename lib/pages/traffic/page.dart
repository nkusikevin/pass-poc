              ...
              TextButton(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: selectedFinesIds.isNotEmpty
                        ? Colors.purple
                        : Colors.grey,
  ...
  Widget _buildFinesList() {
    if (itemCount == 0) {
      return const NoDataFound(
        title: 'No Traffic Fines Found',
        description: 'Great news! You don’t have any outstanding traffic fines.',
        imageIcon: 'assets/images/no_ticket.png',
      );
    }
